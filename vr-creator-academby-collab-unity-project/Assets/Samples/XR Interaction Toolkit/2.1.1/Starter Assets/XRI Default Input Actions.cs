...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Left Grip"",
                    ""type"": ""Value"",
                    ""id"": ""a01b7426-8226-4d4c-b6fb-8233455bb22d"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""35123440-f746-42e2-b44f-b765669700b9"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Right Grip"",
                    ""type"": ""Value"",
                    ""id"": ""99459424-ad7f-49c2-a6fb-658e012cef4e"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""cc490836-28c0-4002-beba-c1b7e3337592"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_LeftGrip = m_XRILeftHand.FindAction("Left Grip", throwIfNotFound: true);
        ...
        m_XRIRightHand_RightGrip = m_XRIRightHand.FindAction("Right Grip", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHand_LeftGrip;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @LeftGrip => m_Wrapper.m_XRILeftHand_LeftGrip;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @LeftGrip.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnLeftGrip;
                @LeftGrip.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnLeftGrip;
                @LeftGrip.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnLeftGrip;
            }
    ...
    private readonly InputAction m_XRIRightHand_RightGrip;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @RightGrip => m_Wrapper.m_XRIRightHand_RightGrip;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @RightGrip.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRightGrip;
                @RightGrip.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRightGrip;
                @RightGrip.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRightGrip;
            }
